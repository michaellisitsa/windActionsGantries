...
cf = inputNumber("Aerodynamic shape factor 'cf' Fig 7.23: ")
...
print(inspect.getfile(wind_calcs.cd_cs))
print(inspect.getmodule(wind_calcs.cd_cs))

#%%
print(inputPrintYesNo("Do you want to see the calculation steps? y = [YES] n = [NO]: ",
inspect.getsource(wind_calcs.cd_cs)[0:-980]))
#inspect.getsource(inputNumber)
# %%
input("Press Any Key to Exit!")
#from main import getsource
#getsource()